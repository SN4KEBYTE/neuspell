        ...
        **kwargs,
        ...
        for epoch_id in range(START_EPOCH, N_EPOCHS + 1):
            ...
            for batch_id, (batch_labels, batch_sentences) in enumerate(train_data_iter):
                ...
                loss.backward()
                # step
                if (batch_id + 1) % gradient_acc_steps == 0 or batch_id >= nbatches - 1:
            ...
            progress_write_file.flush()
            valid_data_iter = batch_iter(valid_data, batch_size=eval_batch_size, shuffle=False)
